    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">APPLICANT SCHEDULE INTERVIEW</h4>
        ...
        <table class="table table-bordered">
            ...
            <tbody id="performanceTableBody">
                 ...
                 <tr>
                  ...
                  <td>{{$inter->interview_date}}</td> 
                          <td>  <?php if($inter->st=='Passed'){
                            ?>
...
<td>
      <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                              ...
                              <form method="POST" action="{{url('interviewfail')}}">
                                 @csrf
                                 @method('POST')
                                 <a class="dropdown-item">
                                    <input type="text" name="failed_id"  value="{{ $inter->interview_id}}" style="display:none;">
                            ...
                            <form method="POST" action="{{url('passed')}}">
                             @csrf
                             @method('POST')
                             <a class="dropdown-item">
                                <input type="text" name="approved_id"  value="{{ $inter->interview_id}}" style="display:none;">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5>APPLICANT SCHEDULE INTERVIEW </h5>
            </div>
...
<form method="POST" action="{{url('interview')}}">
 @csrf
 @method('POST')
