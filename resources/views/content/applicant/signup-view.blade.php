...
<p style="color:blue;text-align:center;font-size:30px;">APPLICANT REGISTER AN ACCOUNT</p>
...
<img src="{{asset('img/avatars/signup.png')}}" style="width:100%;height:400px;position: relative;margin-top:40%;margin-left:10%;">
  </div>
